    ...
    <div className="overflow-x-auto p-4">
      <table className="min-w-[800px] border-collapse border border-gray-200 md:min-w-full">
        <thead className="bg-gray-100">
          <tr>
            <th className="min-w-[150px] border border-gray-200 bg-slate-500 p-2 text-left text-xs text-white sm:text-sm md:text-base">
              First Name
            </th>
            <th className="min-w-[150px] border border-gray-200 bg-slate-500 p-2 text-left text-xs text-white sm:text-sm md:text-base">
              Last Name
            </th>
            <th className="min-w-[350px] border border-gray-200 bg-slate-500 p-2 text-left text-xs text-white sm:text-sm md:text-base">
              Email Address
            </th>
            <th className="min-w-[150px] border border-gray-200 bg-slate-500 p-2 text-left text-xs text-white sm:text-sm md:text-base">
              Phone Number
            ...
            <th className="min-w-[100px] border border-gray-200 bg-slate-500 p-2 text-left text-xs text-white sm:text-sm md:text-base">
              Action
            </th>
          </tr>
        </thead>
      ...
      <div className="mt-4 flex justify-between">
        <button
          ...
          className="rounded bg-secondary-900 px-4 py-2 text-white disabled:opacity-50"
